...
<html>
    ...
    <body>
        <form action="../../Backend/Reg_Method/get_data_M_Tech.php" method="POST" name="M-Tech" enctype="multipart/form-data" class="box">
            <div class = "container">
                <div class = "row">
                    <div class="panel panel-primary">
                        <div class = "panel-heading">
                          <h3 class="text-white text-center font-weight-bold bg-success" >
                              <b>AICTE Registration From ( PGET/GATE alloted or Direct candidate)</b>
                          </h3>
                        ...
                        <table><br>
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td>
                                    <input type="radio" name="E_Type" id="E_Type" value="PGET" >PGET 
                                    <input type="radio" name="E_Type" id="E_Type" value="GATE" >GATE
                            ...
                            <tr>
                                <td><label>What is your PGET/GATE Examination Roll No.? : </label></td>
                                <td><input type="text" name="R_N" id="R_N" placeholder="Enter your PGET/GATE Examination Roll No."></td>
                            </tr>
                            <tr>
                                <td><label>What is your PGET/GATE Rank(As per your valid allotment card)? : </label></td>
                                <td><input type="text" name="Rank" id="Rank" placeholder="Enter your PGET/GATE rank"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="G_N" id="G_N" placeholder="Enter your (Diploma or Graduation) Roll"></td>
                            </tr>
                            <tr>
    ...
    <table>
        ...
        <tr>
            <td><label >10. PGET Allotment Card <br>(If you are a 'Alloted' Candidate) </label>&nbsp;&nbsp;&nbsp;</td>
            <td><input type="file" id="PGET_A_Card" name="PGET_A_Card" ></td>
        </tr>
        <tr>
            <td><label >11. GATE  Rank card <br>(Direct or Management quota)  </label>&nbsp;&nbsp;&nbsp;</td>
            <td><input type="file" id="GATE_R_Card" name="GATE_R_Card" ></td>
        </tr>
    </table>
                            <p>
