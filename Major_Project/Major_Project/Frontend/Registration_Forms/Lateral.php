...
<html>
    ...
    <body>
        <form action="../../Backend/Reg_Method/get_data_Lateral.php" method="POST" name="Lateral" enctype="multipart/form-data" class="box">
            <div class = "container">
                <div class = "row">
                    <div class="panel panel-primary">
                        <div class = "panel-heading">
                          <h3 class="text-white text-center font-weight-bold bg-success" >
                              <b>AICTE Registration From (JELET alloted or Direct candidate)</b>
                            </h3>
                        ...
                        <table >
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="S_Name" id="S_Name" placeholder="Enter your name" value="<?php echo "$s_name";  ?>" required></td>
                            </tr>
                        </table>
                        <table><br><hr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="C_Type" id="C_Type" value="AICTE" required></td>	
                            </tr>
                             <tr>
                                <td><label>Entrance Test/Scholarship : </label></td>
                                <td>
                                    <input type="radio" name="E_Type" id="E_Type" value="JELET ALLOTED" required>JELET ALLOTED
                                    <input type="radio" name="E_Type" id="E_Type" value="DIRECT" required>DIRECT 
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><label>What is your JELET Examination Roll No.? :* </label></td>
                                <td><input type="text" name="R_N" id="R_N" placeholder="Enter your JELET Examination Roll No." required></td>
                            </tr>
                            <tr>
                                <td><label>What is your JELET Rank(As per your valid allotment card)? :* </label></td>
                                <td><input type="text" name="Rank" id="Rank" placeholder="Enter your jelet rank" required></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="radio" name="Category" id="Category" value="General" required>General
                                    <input type="radio" name="Category" id="Category" value="SC" required>SC
                                    <input type="radio" name="Category" id="Category" value="ST" required>ST
                                    <input type="radio" name="Category" id="Category" value="OBC" required>OBC
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><label>What is your (Diploma or Graduation)th Reg.No or Roll No? :* </label></td>
                                <td><input type="text" name="G_N" id="G_N" placeholder="Enter your (Diploma or Graduation) Roll"required></td>
                            </tr>
                            <tr>
                                <td><label>What is your Father's Name? :* </label></td>
                                <td><input type="text" name="F_Name" id="F_Name" placeholder="Enter your Father's Name" required></td>
                            </tr>
                            <tr>
                                <td><label>What is your Mother's Name? :* </label></td>
                                <td><input type="text" name="M_Name" id="M_Name" placeholder="Enter your Mother's Name" required></td>
                            </tr>
                            <tr>
                                <td>Date Of Birth :*</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="radio" name="Gen" id="Gen" value="Others" required>Others
                                </td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="G_Name" id="G_Name" placeholder="Enter Guardian's Name" required></td>
                        </tr>
                        <tr>
                            <td><label>Address :* </label></td>
            
                                   <td><textarea name="G_Address" id="G_Address" placeholder="Enter address" cols="50" rows="3" required></textarea></td>
                            </tr>
                            <tr>
                        ...
                        <table>
                                    ...
                                    <tr>
                                        <td><label>Address :* </label></td>
                                        <td><textarea name="S_Address" id="S_Address" placeholder="Enter address" cols="50" rows="3" required></textarea></td>
                                    </tr>
                                    <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="S_District" id="S_District" placeholder="District" required></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><label>Your Polytechnic/Graduation Examination Name:<br>  type Polytechnic/Graduation Examination of Graduation <br>(refer to your marksheet/statement) :*</label></td>
                                <td><input type="text" name="E_12Name" id="E_12Name" placeholder="Enter Polytechnic/Graduation Examination Name" required></td>
                            </tr>
                            <tr>
                            ...
                            <br>
                             ...
                             <table>
                              <tr>
                                  <td><b>Marks Entry of Graduation or Polytechnic : </b></td>
                                  <tr>
    ...
    <table>
        <tr>
            ...
            <td><input type="text" name="CGPA" id="CGPA" placeholder="Degree /semester per grade" required></td>
        </tr>
    </table>
    <br>
    ...
    <table>
        ...
        <tr>
            <td><label>2. Your Graduation or Final semester of Polytechnic Marks Sheet/ Statement</label>&nbsp;&nbsp;&nbsp;</td>
        ...
        <tr>
            <td><label >10. JELET Allotment Card <br>(If you are a 'Alloted' Candidate) </label>&nbsp;&nbsp;&nbsp;</td>
            <td><input type="file" id="JELET_A_Card" name="JELET_A_Card" ></td>
        </tr>
        <tr>
            <td><label >11. JELET  Rank card <br>(Direct or Management quota)  </label>&nbsp;&nbsp;&nbsp;</td>
            <td><input type="file" id="JELET_R_Card" name="JELET_R_Card" ></td>
        </tr>
    </table>
                            <p>
