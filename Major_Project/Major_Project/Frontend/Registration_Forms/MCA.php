...
<html>
    ...
    <body>
        <form action="../../Backend/Reg_Method/get_data_MCA.php" method="POST" name="MCA" enctype="multipart/form-data" class="box">
            <div class = "container">
                <div class = "row">
                    <div class="panel panel-primary">
                        <div class = "panel-heading">
                          <h3 class="text-white text-center font-weight-bold bg-success" >
                              <b>AICTE Registration From (JECA alloted or Direct candidate)</b>
                          </h3>
                        ...
                        <table><br>
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td>
                                    <input type="radio" name="E_Type" id="E_Type" value="JECA ALLOTED" >JECA ALLOTED
                                    <input type="radio" name="E_Type" id="E_Type" value="DIRECT" >DIRECT 
                                </td>
                            </tr>
                            <tr>
                                <td><label>Course : </label></td>
                                <td><input type="text" name="C_Name" id="C_Name" value="MCA"></td>
                            </tr>
                            <tr>
                                <td><label>What is your JECA Examination Roll No.? : </label></td>
                                <td><input type="text" name="R_N" id="R_N" placeholder="Enter your JECA Examination Roll No."></td>
                            </tr>
                            <tr>
                                <td><label>What is your JECA Rank(As per your valid allotment card)? : </label></td>
                                <td><input type="text" name="Rank" id="Rank" placeholder="Enter your jeca rank"></td>
                            </tr>
                            <tr>
    ...
    <table>
        ...
        <tr>
            <td><label >10. JECA Allotment Card <br>(If you are a 'Alloted' Candidate) </label>&nbsp;&nbsp;&nbsp;</td>
            <td><input type="file" id="JECA_A_Card" name="JECA_A_Card" ></td>
        </tr>
        <tr>
            <td><label >11. JECA  Rank card <br>(Direct or Management quota)  </label>&nbsp;&nbsp;&nbsp;</td>
            <td><input type="file" id="JECA_R_Card" name="JECA_R_Card" ></td>
        </tr>
    </table>
                            <p>
