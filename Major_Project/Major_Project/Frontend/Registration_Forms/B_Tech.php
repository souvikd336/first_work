...
<html>
    ...
    <body >
        <form action="../../Backend/Reg_Method/get_data_B_Tech.php" method="POST" name="B-Tech" enctype="multipart/form-data" class="box">
            <div class = "container">
                <div class = "row">
                    <div class="panel panel-primary">
                        <div class = "panel-heading">
                          <h3 class="text-white text-center font-weight-bold bg-success" >
                              <b>AICTE Registration From (WBJEE / JEE Mains Alloted or Direct Candidate)</b>
                            </h3>
                        ...
                        <table><br><hr>
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td>
                                    <input type="radio" name="E_Type" id="E_Type" value="WBJEE" required>WBJEE
                                    <input type="radio" name="E_Type" id="E_Type" value="JEE (MAINS)" required>JEE (MAINS)
                            ...
                            <tr>
                                <td><label>What is your WBJEE/JEE examination roll no.? :* </label></td>
                                <td><input type="text" name="J_Roll" id="J_Roll" placeholder="Enter your wbjee/jee roll no." required></td>
                            </tr>
                            <tr>
                                <td><label>What is your JEE/Mains Rank(As per your valid allotment card)? :* </label></td>
                                <td><input type="text" name="Rank" id="Rank" placeholder="Enter your jee/mains rank" required></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="A_No" id="A_No" placeholder="Enter your adhaar no."required ></td>
                            </tr>
                            <tr>
    ...
    <table>
        ...
        <tr>
            <td><label>2. Your Class XII Marks Sheet/ Statement</label>&nbsp;&nbsp;&nbsp;</td>
        ...
        <tr>
            <td><label >10. JEE / Mains Allotment Card <br>(If you are a 'Alloted' Candidate) </label>&nbsp;&nbsp;&nbsp;</td>
            <td><input type="file" id="JEE_A_Card" name="JEE_A_Card" ></td>
        </tr>
        <tr>
            <td><label >11. JEE / Mains  Rank card <br>(Direct or Management quota)  </label>&nbsp;&nbsp;&nbsp;</td>
            <td><input type="file" id="JEE_R_Card" name="JEE_R_Card" ></td>
        </tr>
    </table>
                            <p>
