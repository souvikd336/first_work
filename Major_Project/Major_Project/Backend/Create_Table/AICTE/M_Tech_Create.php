...
PGET_Allotment_Card VARCHAR(100),
GATE_Rank_Card VARCHAR(100),
Reg_Date TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
)";

if ($conn->query($sql) === TRUE) {
  echo "Table 130_m-tech created successfully";
} else {
  echo "Error creating table: " . $conn->error;
}

$sql = "CREATE TABLE `226_m-tech` (
Student_Id VARCHAR(10) PRIMARY KEY,
Student_Name VARCHAR(50) NOT NULL,
Course_Under_By VARCHAR(10) DEFAULT 'AICTE',
Entrance_Type VARCHAR(25) NOT NULL,
...
if ($conn->query($sql) === TRUE) {
  echo "Table 226_mtech created successfully";
} else {
  echo "Error creating table: " . $conn->error;
}

$sql = "CREATE TABLE `309_m-tech` (
Student_Id VARCHAR(10) PRIMARY KEY,
Student_Name VARCHAR(50) NOT NULL,
Course_Under_By VARCHAR(10) DEFAULT 'AICTE',
Entrance_Type VARCHAR(25) NOT NULL,
...
if ($conn->query($sql) === TRUE) {
  echo "Table 309_mtech created successfully";
} else {
  echo "Error creating table: " . $conn->error;
}
?>