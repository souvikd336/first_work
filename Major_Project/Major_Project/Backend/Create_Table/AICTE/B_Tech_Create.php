...
JEE_Allotment_Card VARCHAR(100),
JEE_Rank_Card VARCHAR(100),
Reg_Date TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
)";

if ($conn->query($sql) === TRUE) {
  echo "Table 309_b-tech created successfully";
} else {
