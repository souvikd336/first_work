...
$JEE_Allotment_Card = $_FILES['JEE_A_Card'];
$JEE_Rank_Card = $_FILES['JEE_R_Card'];
...
$JEE_Allotment_Card_Name = $JEE_Allotment_Card['name'];
$JEE_Allotment_Card_Path = $JEE_Allotment_Card['tmp_name'];
$JEE_Allotment_Card_Error = $JEE_Allotment_Card['error'];
$JEE_Allotment_Card_Size = $JEE_Allotment_Card['size'];
if($JEE_Allotment_Card_Error == 0 && $JEE_Allotment_Card_Size < 204000){
	$Destination_File = '../../Soft_Copy/'.$table_name.'/'.$S_Id.'_JEE_Allotment_Card.jpg';
	move_uploaded_file($JEE_Allotment_Card_Path, $Destination_File);
	$JEE_Allotment_Card = $Destination_File;
}
else{
	echo "Error or size >= 200KB";
}

$JEE_Rank_Card_Name = $JEE_Rank_Card['name'];
$JEE_Rank_Card_Path = $JEE_Rank_Card['tmp_name'];
$JEE_Rank_Card_Error = $JEE_Rank_Card['error'];
$JEE_Rank_Card_Size = $JEE_Rank_Card['size'];
if($JEE_Rank_Card_Error == 0 && $JEE_Rank_Card_Size < 204000 ){
	$Destination_File = '../../Soft_Copy/'.$table_name.'/'.$S_Id.'_JEE_Rank_Card.jpg';
	move_uploaded_file($JEE_Rank_Card_Path, $Destination_File);
	$JEE_Rank_Card = $Destination_File;
}
else{
	echo "Error or size >= 200KB";
}

$sql = "INSERT INTO `$table_name` (Student_Id,Student_Name,	Course_Under_By,	Entrance_Type,	Course_Name,	JEE_Roll,	RANK,	Course_Type,	CATEGORY,	AADHAAR,	Passing_Year,	RegN_12th,	Fathers_Name,	Mothers_Name,	DOB,	Nationality,	Gender,	Blood_Group,	Religion,	Gurdian_Name,	Gurdian_Address,	Gurdian_Contact,	Relation_With_Student,	Residential_Status,	Student_Address,	Student_State,	Student_District,	Student_Pin,	Student_Mobile,	Student_Altno,	Student_Email,	Examination_Name_12th,	Board,	Paper_1_Name,	Paper_1_Marks,	Paper_2_Name,	Paper_2_Marks,	Paper_3_Name,	Paper_3_Marks,	Paper_4_Name,	Paper_4_Marks,	Paper_5_Name,	Paper_5_Marks,	Paper_6_Name,	Paper_6_Marks,Total_Marks,	Division,	CGPA,	XII_Marks_Sheet,	Aadhaar_Card,	Photo,	Signature,	DOB_Proof,	Anti_Ragging_Declaration,	Domicile_Certificate,	Caste_Certificate,	JEE_Allotment_Card,	JEE_Rank_Card	)
VALUES ('$S_Id','$S_Name',	'$Course_Under_By',	'$Entrance_Type',	'$Course',	'$JEE_Roll',	'$RANK',	'$Course_Type',	'$CATEGORY',	'AADHAAR',	'$Passing_Year',	'$RegN_12th',	'$Fathers_Name',	'$Mothers_Name',	'$DOB',	'$Nationality',	'$Gender',	'$Blood_Group',	'$Religion',	'$Gurdian_Name',	'$Gurdian_Address',	'$Gurdian_Contact',	'$Relation_With_Student',	'$Residential_Status',	'$Student_Address',	'$Student_State',	'$Student_District',	'$Student_Pin',	'$Student_Mobile',	'$Student_Altno',	'$Student_Email',	'$Examination_Name_12th',	'$Board',	'$Paper_1_Name',	'$Paper_1_Marks',	'$Paper_2_Name',	'$Paper_2_Marks',	'$Paper_3_Name',	'$Paper_3_Marks',	'$Paper_4_Name',	'$Paper_4_Marks',	'$Paper_5_Name',	'$Paper_5_Marks',	'$Paper_6_Name',	'$Paper_6_Marks','$Total_Marks',	'$Division',	'$CGPA',	'$XII_Marks_Sheet',	'$Aadhaar_Card',	'$Photo',	'$Signature',	'$DOB_Proof',
	'$Anti_Ragging_Declaration',	'$Domicile_Certificate',	'$Caste_Certificate',	'$JEE_Allotment_Card',	'$JEE_Rank_Card')";
